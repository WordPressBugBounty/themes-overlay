...
if( get_theme_mod( 'overlay-social-x' ) ) :
    echo '<a href="' . esc_url( get_theme_mod( 'overlay-social-x' ) ) . '" target="_blank" title="' . esc_attr__( 'Find Us on X', 'overlay' ) . '" class="social-icon social-x"><i class="fab fa-x-twitter"></i></a>';
endif;
